...
// import { useActions, useAppDispatch, useAppSelector } from "@/hooks/useStore";
import useStore from "@/hooks/useStore";

export default function Products() {
  const { actions, useAppDispatch, useAppSelector } = useStore();
      ...
      <div className="max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <div className="flex flex-col gap-2 ">
          <h2 className="text-2xl font-bold tracking-tight text-gray-900">
            Tema: {mode} na porta 3001 tela Produtos
          </h2>
